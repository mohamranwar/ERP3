...
const SUPPORTED_TABLES: TableConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'selling_price', label: 'Selling Price ($)', required: false, type: 'number', description: 'Wholesale unit selling price.' },
      { key: 'standard_cost', label: 'Standard Cost ($)', required: false, type: 'number', description: 'Production cost per unit.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'standard_cost', label: 'Standard Cost ($)', required: false, type: 'number', description: 'Unit cost.' }
    ]
  },
  {
    id: 'suppliers',
      ...
      <div className="p-6 overflow-y-auto space-y-6 flex-1 max-h-[calc(85vh-140px)]">
        ...
        <div className="bg-slate-50 border border-slate-200/60 p-4.5 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-700 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 hover:text-blue-600 transition-all shadow-3xs hover:border-slate-400 shrink-0 self-start md:self-auto"
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <button
                ...
                onClick={handleParse}
                className="flex items-center gap-1.5 px-4.5 py-1.5 text-xs font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-xs"
              >
      ...
      <div className="flex justify-between items-center gap-3 px-6 py-4.5 bg-slate-50 border-t border-slate-200 shrink-0">
        ...
        <div className="flex gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 text-xs font-extrabold text-white bg-blue-600 rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md active:bg-blue-800"
          >
            {isImporting ? (
              <>
